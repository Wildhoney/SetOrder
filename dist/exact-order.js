...
const byNested = order => {
    ...
    return function sort(a, b, index$$1 = 0) {

        const key = keys[index$$1];

        const [firstIndex, secondIndex] = [
            order[key].findIndex(c => c === index.get(a, key)),
            order[key].findIndex(c => c === index.get(b, key))
        ];

        return firstIndex === secondIndex ? sort(a, b, index$$1 + 1) : firstIndex > secondIndex;
